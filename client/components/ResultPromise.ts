import { reactive, watch, defineComponent, h, VNode } from 'vue'
...
export default defineComponent(
	<T, E>(props: { promise: Promise<Result<T, E>> | null, tag: string }, { slots }: { slots: SlotsType }) => {
		...
		return () => {
			...
			return h(props.tag, defaultItems.concat(
				...
				: slots.ok && stater.resolved ? slots.ok(state.ok)
